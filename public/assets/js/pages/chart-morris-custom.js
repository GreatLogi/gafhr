...
$(document).ready(function() {
    setTimeout(function() {
        ...
        Morris.Bar({
            ...
            barColors: ["#1d0660", "#536dfe", "#9ccc65"]
        });
        ...
        Morris.Bar({
            ...
            ykeys: ['a', 'b', 'c'],
            labels: ['Bar 1', 'Bar 2', 'Bar 3'],
            barColors: ["#ffba57", "#ff5252", "#1d0660"]
        });
        ...
        Morris.Area({
            ...
            lineColors: ['#9ccc65', '#536dfe', '#1d0660'],
            xkey: 'period',
        ...
        var graph_real = Morris.Line({
            ...
            ymin: -1.0,
            ymax: 1.0,
            lineColors: ['#ffba57', '#ff5252', '#1d0660'],
            pointSize: 4,
            responsive: true,
            pointFillColors: ['#fff', '#fff', '#fff'],
            pointStrokeColors: ['#ffba57', '#ff5252', '#1d0660'],
            lineWidth: 2,
            hideHover: true
        });
