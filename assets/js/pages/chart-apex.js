    ...
    setTimeout(function() {
        ...
        $(function() {
            var options = {
                ...
                colors: ["#1d0660", "#0e9e4a", "#ffba57", "#ff5252"],
                responsive: [{
                    breakpoint: 480,
                    options: {
                        legend: {
        ...
        $(function() {
            var options = {
                ...
                colors: ["#1d0660", "#00acc1", "#0e9e4a", "#ffba57", "#ff5252"],
                stroke: {
                    width: 1,
                    colors: ['#fff']
                },
        ...
        $(function() {
            var options = {
                ...
                colors: ["#1d0660", "#0e9e4a", "#ff5252", "#ffba57", "#00acc1"],
                series: [{
                    name: "SAMPLE A",
                    data: [
                        [16.4, 5.4],
        ...
        $(function() {
            var options = {
                ...
                colors: ["#1d0660", "#0e9e4a", "#00acc1", "#ffba57", "#ff5252"],
                legend: {
                    show: true,
                    position: 'bottom',
                },
