...
<body>
    ...
    <div class="text-center footer bg-light" id="footerdiv">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p id="copy">&copy; {{ date('Y') }} GAF HR-Travel Information Display Management System |
                        All Rights
    ...
    <script>
        document.getElementById('copy').innerHTML = 'Copyright &copy; ' + (new Date().getFullYear()) +
            'GAF HR-Travel Information Display System |Powered By GHQ(DIT)| All Rights Reserved.'
    </script>
    </div>
    </div>
