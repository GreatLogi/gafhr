   ...
   --}}
    ...
    <div class="card">
        <div class="card-body py-2 text-center">
            ...
            <a href="{{ route('travel-dash') }}" class="badge badge-info" style="display: inline;">GO TO DASHBAORD</a>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            <div class="dt-responsive table-responsive">
                                <div class="dt-responsive table-responsive">
                                    <table id="returned" class="table table-striped table-bordered nowrap">
                                        <thead>
                                            <tr>
                                                <th>
                                                    No.
    ...
    <script>
        ...
        //         ],
        //         ajax: {
        //             url: "{{ route('personnel-returned-from-travel') }}",
        //             type: 'POST',
        //             headers: {
        ...
        $(document).ready(function() {
            ...
            function reloadTable() {
                $('#returned').DataTable().ajax.reload();
            }
