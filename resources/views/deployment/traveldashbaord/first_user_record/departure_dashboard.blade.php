                ...
                <div class="card card-border-c-yellow">
                    <div class="card-body" style="">
                        <div class="row align-items-center m-l-0">
                            <div class="col-auto">
                                <i class="fas fa-paper-plane f-36 text-c-yellow"></i>
                            </div>
                            <div class="col-auto">
            ...
            <a href="{{ route('approve-pending-departures') }}">
                <div class="card card-border-c-blue">
                    <div class="card-body" style="">
                        <div class="row align-items-center m-l-0">
                            <div class="col-auto">
                                <i class="fas fa-user-check f-36 text-c-blue"></i>
                            </div>
                            <div class="col-auto">
                                <h5 style="color:#0722f5">DEPARTURES</h5>
        ...
        <div class="col-xl-2 col-md-6">
            <div class="card card-border-c-green">
                <div class="card-body" style=""><a href="{{ route('approve-arrival-returns') }}">
                        <div class="row align-items-center m-l-0">
                            <div class="col-auto">
                                <i class="fas fa-user-clock f-36 text-c-green"></i>
                            </div>
                            <div class="col-auto">
                                <h5 style="color:rgb(115, 185, 44)">ARRIVALS</h5>
                    ...
                    <div class="row align-items-center m-l-0">
                        <div class="col-auto">
                            <div class="col-xl-4 col-md-6 mb-2">
                                <div class="btn-group" role="group" aria-label="button groups" style="">
                                    ...
                                    <button><a href="{{ route('admin.index') }}" class=""><i
                                                class="feather icon-home"></i>HOME</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#approve').DataTable({
                ...
                ajax: {
                    url: "{{ route('api-approve-user-first-dashboard') }}",
                    type: 'POST',
                    headers: {
        ...
        //                 d.startDate = $('#startDate').val();
        //                 d.endDate = $('#endDate').val();
        //                 console.log("Sending dates to server:", d.startDate, d.endDate); // Debugging
        //             }
        //         },
        //         columns: [{
        //                 data: null,
        ...
        //         $('#startDate').val(startDate);
        //         $('#endDate').val(endDate);
        //         console.log("Setting date range:", startDate, endDate); // Debugging
        //         dataTable.draw();
        //     }
        ...
        //     $('#filter-week').on('click', function() {
        //         var today = new Date();
        //         var startOfWeek = new Date(today.setDate(today.getDate() - today
        //     .getDay())); // Start of the week
        //         var endOfWeek = new Date(today.setDate(today.getDate() - today.getDay() +
        //         6)); // End of the week
        //         setDateRange(startOfWeek.toISOString().split('T')[0], endOfWeek.toISOString().split('T')[
        //         0]);
        //     });
        ...
        //     $('#filter-month').on('click', function() {
        //         var today = new Date();
        //         var startOfMonth = new Date(today.getFullYear(), today.getMonth(),
        //         1); // Start from first day of the month
        //         var endOfMonth = new Date(today.getFullYear(), today.getMonth() + 1,
        //         0); // End on the last day of the month
        //         setDateRange(startOfMonth.toISOString().split('T')[0], endOfMonth.toISOString().split('T')[
        //             0]);
        //     });
