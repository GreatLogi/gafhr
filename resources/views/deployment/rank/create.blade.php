...
@section('admin')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('rank-store') }}" method="POST" id="myForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="rank_name" class="col-sm-3 col-form-label">Enter Rank</label>
                                    <div class="col-sm-9">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="arm_of_service" class="form-control select2">
                                            <option selected="">Select Service</option>
                                            @foreach ($ser as $cat)
                                                <option value="{{ $cat->id }}">{{ $cat->arm_of_service }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
