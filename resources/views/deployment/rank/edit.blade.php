...
@section('admin')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('rank-update', $rank->uuid) }}" method="POST" id="myForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="arm_of_service" value="" class="form-control">
                                            <option selected="">Select Service</option>
                                            @foreach ($ser as $sup)
                                                <option
                                                    value="{{ $sup->id }}"{{ $sup->id == $rank->arm_of_service ? 'selected' : '' }}>
                                                    {{ $sup->arm_of_service }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
