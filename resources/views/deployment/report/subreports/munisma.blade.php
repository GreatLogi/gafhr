            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Summary Report MUNISMA</h5>
                    </div>
                    <ul class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"
                    ...
                    <img src="{{ asset('assets/images/auth/minusma-logo.jpeg') }}" style="width: 5%;" class="rounded"
                        alt="...">
                    <h3 style="color:rgb(8, 141, 218);">PAST MINUSMA GHANBATT DEPLOYMENT DETAILS</h3><hr>
                </div>
                <div class="card-body" style="padding-top: 10px">
                    <div class="row">
                        <div class="col-md-6">
                            <form action="{{ route('minusma-filter') }}" method="POST">
                                @csrf
                        ...
                        <div class="col-md-3">
                            <div class="card support-bar overflow-hidden">
                                <div class="card-body pb-0">
                                    @php
                                        $latestGhannattCount = \App\Models\GafMissionRecord::where('mission_name', 'MUNISMA')
                                            ->where('status', 4)
                                    ...
                                    <div class="row text-center">
                                        ...
                                        <div class="col">
                                            <h4 class="m-0 text-white">
                                                {{ $MunimaMaleCount = \App\Models\GafMissionRecord::where('gender', 'MALE')->where('mission_name', 'MUNISMA')->where('status', 4)->count() }}
                                            </h4>
                                            <span>MALE</span>
                                        </div>
                                        <div class="col">
                                            <h4 class="m-0 text-white">
                                                {{ $MunimaFemaleCount = \App\Models\GafMissionRecord::where('gender', 'FEMALE')->where('mission_name', 'MUNISMA')->where('status', 4)->count() }}
                                            </h4>
                                            <span>FEMALE</span>
                                        </div>
                                    </div>
                            ...
                            <div class="card support-bar overflow-hidden">
                                ...
                                <div class="card-footer bg-success text-white">
                                    <div class="row text-center">
                                        ...
                                        <div class="col">
                                            <h4 class="m-0 text-white">
                                                {{ $MonuscoMaleCount = \App\Models\GafMissionRecord::where('gender', 'MALE')->where('mission_name', 'MUNISMA')->where('status', 1)->latest('departure_date')->count() }}
                                            </h4>
                                            <span>MALE</span>
                                        </div>
                                        <div class="col">
                                            <h4 class="m-0 text-white">
                                                {{ $MonuscoFemaleCount = \App\Models\GafMissionRecord::where('gender', 'FEMALE')->where('mission_name', 'MUNISMA')->where('status', 1)->latest('departure_date')->count() }}
                                            </h4>
                                            <span>FEMALE</span>
                                        </div>
                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($reports as $item)
                                            <tr>
                                                ...
                                                <td>{{ substr($record->initial, 0, 2) . ' ' . substr($record->initial, 2) }}
                                                <td>{{ $item->appointment_name }}</td>
                                                <td>{{ $item->mission_name }}</td>
                                                <td>{{ $item->ghanbatt_name }}</td>
                                                <td>{{ $item->chalk_list }}</td>
                                                <td>{{ $item->country }}</td>
                                                <td> {{ date('d M, Y', strtotime($record->departure_date)) }}</td>
