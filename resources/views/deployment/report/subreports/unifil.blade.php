            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Summary Report UNIFIL</h5>
                    </div>
                    <ul class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"
                        ...
                        <img src="{{ asset('assets/images/auth/UNIFIL-Vector2.png') }}" style="width: 6%;" class="rounded"
                            alt="...">
                        <h3 style="color:rgb(8, 141, 218);">PAST UNFIL GHANBATT DEPLOYMENT DETAILS</h3>
                        <hr>
                    </div>
                    <div class="card-body" style="padding-top: 10px">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ route('api-filter-unifil') }}" method="POST" id="filter-form">
                                    @csrf
                            ...
                            <div class="col-md-3">
                                <div class="card support-bar overflow-hidden">
                                    <div class="card-body pb-0">
                                        @php
                                            $latestGhannattCount = \App\Models\GafMissionRecord::where('mission_name', 'UNIFIL')
                                                ->whereIn('status', [5, 6])
                                        ...
                                        <div class="row text-center">
                                            ...
                                            <div class="col">
                                                <h4 class="m-0 text-white">
                                                    {{ $UNIFILMaleCount = \App\Models\GafMissionRecord::where('gender', 'MALE')->where('mission_name', 'UNIFIL')->whereIn('status', [5, 6])->count() }}
                                                </h4>
                                                <span>MALE</span>
                                            </div>
                                            <div class="col">
                                                <h4 class="m-0 text-white">
                                                    {{ $UNIFILFemaleCount = \App\Models\GafMissionRecord::where('gender', 'FEMALE')->where('mission_name', 'UNIFIL')->whereIn('status', [5, 6])->count() }}
                                                </h4>
                                                <span>FEMALE</span>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="card support-bar overflow-hidden">
                                    <div class="card-body pb-0">
                                        @php
                                            $latestGhannattCount = \App\Models\GafMissionRecord::where('mission_name', 'UNIFIL')->where('status', 2)->whereNotNull('ghanbatt_name')->whereDate('departure_date', '<=', now())->latest('departure_date')->count();
                                            $UNIFILMaleCount = \App\Models\GafMissionRecord::where('gender', 'MALE')->where('mission_name', 'UNIFIL')->where('status', 2)->whereDate('departure_date', '<=', now())->latest('departure_date')->count();
                                            $UNIFILFemaleCount = \App\Models\GafMissionRecord::where('gender', 'FEMALE')->where('mission_name', 'UNIFIL')->where('status', 2)->whereDate('departure_date', '<=', now())->latest('departure_date')->count();
                                        @endphp
                                    ...
                                    <div class="card-footer bg-success text-white">
                                        <div class="row text-center">
                                            ...
                                            <div class="col">
                                                <h4 class="m-0 text-white">{{ $UNIFILMaleCount }}</h4>
                                                <span>MALE</span>
                                            </div>
                                            <div class="col">
                                                <h4 class="m-0 text-white">{{ $UNIFILFemaleCount }}</h4>
                                                <span>FEMALE</span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#filter-form').submit(function(e) {
                e.preventDefault();
                dataTable.ajax.url("{{ route('api-filter-unifil') }}").settings()[0].ajax.type = 'POST';
                dataTable.draw();
            });
        });
    </script>
