                ...
                <div class="card-body">
                    <div class="row align-items-center m-l-0">
                        <div class="col-sm-6 text-left"><br />
                            <p>Perform these Actions on Country.</p>
                        </div>
                        <div class="col-sm-6 text-right"><br />
                            <div class="btn-group mb-2 mr-2" style="display: inline-block;">
                                <a href="{{ route('mech-country') }}" class="btn  btn-primary " type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary btn-sm"
                                                        href="{{ route('edit-country', $record->uuid) }}"><i
                                                            class="feather icon-edit"> </i></a>
                                                    <a class="btn btn-danger btn-sm"
                                                        href="{{ route('delete-country', $record->uuid) }}"
